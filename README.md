...
Below is a short description of each piece, with links to the **Live Apps**.  
...
## 10. [Fibonacci Zoom Out](https://marlonbarrios.github.io/fibonacci_zoomout/)
An infinite zoom based on Fibonacci scaling.  
A meditation on temporal recursion, self-similarity, and mathematical memory.

## 11. [Captive Network](https://marlonbarrios.github.io/captivenetwork/)
...
and how systems reorganize themselves through recursive observation.

---

## In Summary

**Time Instances: Epistemic Gestures of Becoming** is an installation where each screen becomes a lens on time:  
